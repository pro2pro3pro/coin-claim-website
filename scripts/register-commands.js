...
(async()=>{
  const r = await fetch(https://discord.com/api/v10/applications//guilds//commands, {
    method:'PUT', headers:{ Authorization:Bot , 'Content-Type':'application/json' }, body: JSON.stringify(commands)
  });
